...
| Ship it
| 20 min
| Push code, view CI pipeline in Developer Hub, fix a pipeline failure, push again

| Go live
| 15 min
| Merge to main, watch GitOps deploy, verify the feature in production, explore the OpenShift Console
|===
