...
Your changes are now merged into the main branch. The dev environment pipeline will pick this up and redeploy automatically. But to promote to production, you need to create a release.
